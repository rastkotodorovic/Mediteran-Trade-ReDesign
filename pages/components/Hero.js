    ...
    return (
      <div class="lg:container">
            <div class="lg:flex lg:justify-between lg:py-20 lg:p-0 p-7">
                ...
                <div class="lg:w-1/2 pt-7">
                    <h2 class="h1">
                        Računovodstvene usluge na <br></br> području Bosne i Hercegovine
                    </h2>
            ...
            <div class="lg:flex mt-6 lg:p-0 lg:pb-12 p-7">
                <div class="pb-6 lg:w-1/3 lg:pr-16"  data-aos="fade-down">
                    <div class="mb-3">
                    ...
                    <h2 class="title mb-3">Izrada obračuna</h2>
                    <p class="paragraph">Landkit is built to make your life easier. Variables, build tooling, documentation, and reusable components.</p>
                </div>
                <div class="pb-6 lg:w-1/3 lg:pr-12"  data-aos="fade-down">
                    <div class="mb-3">
                    ...
                    <h2 class="title mb-3">Obračun plata</h2>
                    <p class="paragraph">Designed with the latest design trends in mind. Landkit feels modern, minimal, and beautiful.</p>
                </div>
                <div class="pb-6 lg:w-1/3 lg:pl-4"  data-aos="fade-down">
                    <div class="mb-3">
                    ...
                    <h2 class="title mb-3">Obračun PDV-a</h2>
                    <p class="paragraph">We've written extensive documentation for components and tools, so you never have to reverse engineer anything.</p>
                </div>
            </div>
      </div>
    )
