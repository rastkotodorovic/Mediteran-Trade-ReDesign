    ...
    return (
        <div className="bg-gray-100 lg:mb-56 mb-24" data-aos="fade-down">
            <div className="lg:flex lg:justify-between lg:p-0 p-4">
                ...
                <div className="lg:w-1/2  lg:pl-32 lg:pt-36 lg:mb-2 lg:pr-72 lg:text-left text-center lg:mt-0 mt-4">
                    <h2 className="title mb-3">Locirani smo u Bijeljini.</h2>
                    <h2 className="title text-blue-600 mb-8">Agrotrzni centar</h2>
